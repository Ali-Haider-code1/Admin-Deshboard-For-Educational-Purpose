...
$quizId = $_GET['quizId']; // Retrieve course ID from URL parameter

$sql = "SELECT id, coursecode, coursename, teachername, quiz,quizdate FROM quiz_details";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            header("Location: quiz.php"); // Change to the actual URL
        } else {
