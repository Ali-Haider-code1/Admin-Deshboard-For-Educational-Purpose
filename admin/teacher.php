              ...
              <tbody>
                ...
                if ($result) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<div>';
                    echo '<img src="../assets/img/team-3.jpg" class="avatar avatar-sm me-3">';
                    echo '</div>';
                    ...
                    echo '</td>';
                    echo '<td>';
                    echo '<p class="text-xs text-secondary mb-0">' . $description . '</p>';
                    echo '</td>';
                    echo '<td class="align-middle text-center">';
                    echo '<span class="text-secondary text-xs font-weight-bold">' . $contactNumber . '</span>';
                    echo '</td>';

                    echo '<td class="align-right">';
                    echo '<a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" onclick="editTeacher(' . $teacherId . ')">';
                    echo '<i class="fa fa-edit"></i>';
                    echo '</a> |';
                    echo '<a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete user" onclick="deleteTeacher(' . $teacherId . ')">';
